// //os detalhes de composições em
// //https://brm.io/matter-js/docs/classes/Composites.html


//https://nicolas34110.github.io/Jogo-do-Coelho3/
...
var fruit,  fruit_con, fruit_con_2, fruit_con_3;
...
frameRate(80);
  ...
  rope2 = new Rope(7, {x: 330,y: 25});
  rope3 = new Rope(4, {x: 370,y: 210});
  ...
  button2.position(290,20);
  button2.size(60,60);
  button2.mouseClicked(drop2);

  button3 = createImg("cut_btn.png");
  button3.position(330,185);
  button3.size(60,60);
...
push();
  imageMode(CENTER);
  if(fruit != null){
    image(fruit_img, fruit.position.x, 
      fruit.position.y, 60,60);
  }
pop();
